...
class RegistrationFieldRegistry
{
    ...
    public static function presets(): array
    {
        return [
            ...
            'date_of_birth' => [
                'key'         => 'date_of_birth',
                'label'       => __('Date of Birth', 'hmw-events'),
                'type'        => 'date',
                'source'      => self::SOURCE_REGISTRANT_META,
                'meta_key'    => 'registrant_date_of_birth',
                'width'       => 'half',
                'required'    => false,
                'placeholder' => '',
            ],
            'session_picker' => [
                'key'         => 'session_picker',
                'label'       => __('Select Sessions', 'hmw-events'),
                'type'        => 'session_picker',
            ...
            'attendee_role' => [
                'key'         => 'attendee_role',
                'label'       => __('Attendee Role', 'hmw-events'),
                'type'        => 'select',
                'source'      => self::SOURCE_REGISTRANT_META,
                'meta_key'    => 'registrant_attendee_role',
                'width'       => 'half',
                'required'    => false,
                'placeholder' => '',
                'options'     => [
                    ['value' => 'adult', 'label' => __('Adult', 'hmw-events')],
                    ['value' => 'child', 'label' => __('Child', 'hmw-events')],
                ],
            ],
            'organisation' => [
                'key'         => 'organisation',
