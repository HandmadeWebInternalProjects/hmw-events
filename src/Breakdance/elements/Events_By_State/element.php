...
class EventsByState extends \Breakdance\Elements\Element
{
    ...
    {
        return ['0' =>  ['scripts' => ['%%BREAKDANCE_REUSABLE_CMS%%/src/Breakdance/elements/Events_By_State/EducatorsByState.js'],'inlineScripts' => ['function initMap() {
