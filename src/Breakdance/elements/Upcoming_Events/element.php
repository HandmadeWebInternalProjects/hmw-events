...
class UpcomingEvents extends \Breakdance\Elements\Element
{
    ...
    {
        return ['0' =>  ['scripts' => ['%%BREAKDANCE_REUSABLE_CMS%%/src/Breakdance/elements/Upcoming_Events/EducatorUpcomingCourses.js'],'inlineScripts' => ['function initUpcomingCourses() {
