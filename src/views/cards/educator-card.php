...
$avatar = wp_get_attachment_image(get_field('educator_profile_image', $user_id)); // Debug line to check avatar value
$suburb = get_field('educator_suburb', $user_id);
$state_field = get_field('educator_state', $user_id);
...
<div class="educator-card" data-educator-id="<?php echo esc_attr($educator->ID); ?>">
  <!-- Educator Header -->
  ...
  <?php
  $educator_accreditation = get_field('educator_accreditation', $user_id);
  if ($educator_accreditation) : ?>
    <div class="educator-card-icon-list educator-credentials">
      <!-- graduation hat icon -->
      <svg class="educator-card-icon" xmlns=" http://www.w3.org/2000/svg" viewBox="0 0 32 32">
      ...
      <span class="credential-badge"><?php echo esc_html($educator_accreditation); ?></span>

    </div>
  <?php endif; ?>

  <!-- Location -->
  <div class="educator-card-icon-list educator-location">
    <svg class="educator-card-icon icon-map-pin" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
  ...
  <!-- Upcoming Courses -->
  <div class="educator-card-icon-list educator-courses">
    <svg class="educator-card-icon icon-calendar" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
