...
class EventTemplateOverrideService
{
    ...
    {
        $meta = get_post_meta($event_id, self::OVERRIDE_META_KEY, true);
    ...
    private function get_resolved_field_config(int $event_id): ?array
    {
        ...
        $field_config = get_post_meta($event_id, '_event_field_config', true);
    ...
    {
        $event_meta = get_post_meta($event_id, '_event_default_values', true);
