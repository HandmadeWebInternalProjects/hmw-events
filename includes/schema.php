...
function hmwevents_get_schema(): array
{
    ...
    return [
        ...
        'event_recurrence' => "CREATE TABLE {$prefix}event_recurrence (
            ...
            recurrence_times varchar(100) DEFAULT NULL COMMENT 'Comma-separated H:i:s start times for multiple same-day sessions',
        ...
        'event_attendance_options' => "CREATE TABLE {$prefix}event_attendance_options (
            ...
            capacity int UNSIGNED DEFAULT NULL COMMENT 'Maximum number of bookings for this option. NULL = unlimited',
        ...
        'bookings' => "CREATE TABLE {$prefix}bookings (
            ...
            cancel_token varchar(64) DEFAULT NULL COMMENT 'Self-cancellation token',
